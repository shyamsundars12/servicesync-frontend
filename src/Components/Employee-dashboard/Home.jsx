...
const Home = (props) => {
  ...
  useEffect(() => {
    ...
    axios.post(`https://servicesync-backend.vercel.app/employee/getTodaySchedules`, data)
      .then((response) => {
    ...
    axios.post(`https://servicesync-backend.vercel.app/employee/getUpcomingSchedules`, data)
      .then((response) => {
    ...
    axios.post(`https://servicesync-backend.vercel.app/employee/completed`, data)
      .then((response) => {
    ...
    axios.post(`https://servicesync-backend.vercel.app/employee/avgRating`, data)
      .then((response) => {
  ...
  useEffect(() => {
    ...
    axios
      .post("https://servicesync-backend.vercel.app/order/getActiveService")
      .then((response) => {
        ...
        if (response?.data?.length > 0) {
          ...
          console.log(data)
          axios
            .post("https://servicesync-backend.vercel.app/order/getAddOns", data)
            .then((response) => {
              console.log(response.data);
  ...
  const handleOrderDetails = (item) => {
    ...
    try {
      ...
      axios.post("https://servicesync-backend.vercel.app/order/getOrderById", item)
        .then((response) => {
          console.log(response.data)
          // setorder(response.data)
        })
  ...
  const handleCompleted = (item) => {
    ...
    try {
      ...
      axios.post("https://servicesync-backend.vercel.app/order/sendOTP", data)
        .then((response) => {
          console.log("ok")
  ...
  const handleSubmit = () => {
    ...
    try {
      ...
      axios.post("https://servicesync-backend.vercel.app/order/completeOrder", data)
        .then((response) => {
          // console.log("ok")
  ...
  const handleAddon = (item) => {
    ...
    try {
      ...
      axios.post("https://servicesync-backend.vercel.app/addOn/getAddOnBySerId", data)
        .then((response) => {
          console.log(response.data)
  ...
  const handleAddonadd = (item) => {
    ...
    try {
      ...
      axios.post("https://servicesync-backend.vercel.app/order/addAddons", data)
        .then((response) => {
          console.log(response.data)
  ...
  //     axios.post("https://servicesync-backend.vercel.app/order/getAddOns", data)
  //       .then((response) => {
  ...
  const handledeleteAddon = (item) => {
    ...
    try {
      ...
      axios.post("https://servicesync-backend.vercel.app/order/removeAddOns", data)
        .then((response) => {
