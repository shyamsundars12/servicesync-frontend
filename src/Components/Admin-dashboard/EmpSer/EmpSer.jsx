...
const EmpSer = () => {
    ...
    const HandleOpen = (item) => {
        ...
        try {
            ...
            axios.post("https://servicesync-backend.vercel.app/empser/getEmpSerByEmpId/", item)
                .then((response) => {
    ...
    const HandleDelete =(item) =>{
        ...
        try {
            ...
            axios.post("https://servicesync-backend.vercel.app/empser/removeService/", datarem)
                .then((response) => {
    ...
    const handleADDservices = (item)=>{
        ...
        try {
            ...
            axios.post("https://servicesync-backend.vercel.app/empser/addService/", data)
                .then((response) => {
                console.log(response.data);
                Swal.fire({
